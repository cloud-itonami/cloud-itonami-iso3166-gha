(ns marketentry.store
  "SSoT for the GHA market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems GH" :portal "GHANEPS/PPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-gh-entity? true :has-gh-entity? true
             :requires-tin? true :tin-verified? true
             :drafted? false :submitted? false
             :jurisdiction "GHA" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "GHANEPS/PPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-gh-entity? true :has-gh-entity? true
             :requires-tin? true :tin-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "GHANEPS/PPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "GHA" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "GHANEPS/PPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-gh-entity? true :has-gh-entity? false
             :requires-tin? true :tin-verified? true
             :drafted? false :submitted? false
             :jurisdiction "GHA" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "GHANEPS/PPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-gh-entity? true :has-gh-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "GHA" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "GHANEPS/PPA"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-gh-entity? has-gh-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-gh-entity?)  (assoc :engagement/requires-gh-entity? requires-gh-entity?)
    (some? has-gh-entity?)       (assoc :engagement/has-gh-entity? has-gh-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-gh-entity? :engagement/has-gh-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-gh-entity? (boolean (:engagement/requires-gh-entity? m))
     :has-gh-entity? (boolean (:engagement/has-gh-entity? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-gha"})
