...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (GHA, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up gh-entity-missing) ==")
    ...
    (println "== filing/submit eng-4 (gh-entity-missing -> HARD hold) ==")
